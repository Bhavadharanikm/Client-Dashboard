(function () {
  ...
  function revenueNext30Label(listing) {
    const windowData = listing.windows["30"] || {};
    const revenue = Number(windowData.potentialRevenue) || 0;
    return '<span class="revenue-next-30">' + escapeHtml(formatMoney(revenue)) + "</span>";
  }
  ...
  function renderWindowDetail(listing, windowKey) {
    ...
    return '<div class="dw-flat-layout">' +
      '<div class="detail-win dw-flat-card">' +
        '<div class="dw-flat-metrics">' +
          '<div class="dw-metric-block dw-metric-occ">' +
            ...
            "</div>" +
          "</div>" +
          '<div class="dw-metric-block dw-metric-fill">' +
          ...
          "</div>" +
          '<div class="dw-metric-block dw-metric-revenue">' +
  ...
  function render(container, options) {
    ...
    container.innerHTML = [
      ...
      '<div class="pp-subtitle">Upcoming occupancy and projected revenue over the next 30, 60, and 90 days.</div>',
      '</header>',
      ...
      '<div class="kpi-card"><div class="kpi-val gold">' + escapeHtml(formatMoney(summary.openValue)) + '</div><div class="kpi-lbl">Open Value <span style="font-size:0.75em;color:#000;font-weight:600;white-space:nowrap;">(direct booking revenue)</span></div></div>',
      "</div>",
      ...
      "</div>",
      "</div>",
      '<div class="port-table-wrap"><table class="port-table"><thead class="pt-head"><tr><th>Listing</th><th>30D</th><th>60D</th><th>90D</th><th>Trend</th><th style="text-align:center">Revenue (Next 30D)</th><th></th></tr></thead><tbody>',
      visibleListings.map(function (listing) {
        ...
        return '<tr class="pt-row' + (isOpen ? " active" : "") + '" data-pricing-row="' + escapeHtml(rowId) + '">' +
          ...
          '<td style="text-align:center">' + revenueNext30Label(listing) + "</td>" +
