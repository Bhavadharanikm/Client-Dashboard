...
def build_roi_row(row_map: dict[str, object]):
    ...
    return {
        ...
        "total_booking_revenue": clean_number(get_value(row_map, "total_booking_revenue", "total_revenue")) or 0,
        "direct_booking_revenue": clean_number(get_value(row_map, "direct_booking_revenue", "direct_revenue")) or 0,
        "direct_booking_split_pct": clean_number(get_value(row_map, "direct_booking_split", "direct_booking_split_pct", "direct_split")) or 0,
        "ly_total_booking_revenue": clean_number(get_value(row_map, "ly_total_booking_revenue", "ly_total_revenue")) or 0,
        "ly_direct_booking_revenue": clean_number(get_value(row_map, "ly_direct_booking_revenue", "ly_direct_revenue")) or 0,
        "ly_direct_booking_split_pct": clean_number(get_value(row_map, "ly_direct_booking_split", "ly_direct_booking_split_pct", "ly_direct_split")) or 0,
    ...
    for sheet_config in sheet_configs:
        ...
        for row in sheet.iter_rows(min_row=header_row_index + 1, max_col=sheet.max_column, values_only=True):
            ...
            payload = {
                ...
                "leads_followers": get_value(row_map, "leads_followers", "followers_leads"),
